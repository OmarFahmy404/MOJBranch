...
public class WarningsFeesPage extends PageBase {
	...
	public void createWarAttachWithCaseFirstTime(String serialCaseNum, String paperCount, String receiverCount,
			String nationalId, String descripeGeneralWar) throws InterruptedException {
		fluentWait(addBtn);
		clickBtn(addBtn);
	...
	public void createWarAttachWithCaseForSecondeTime(String serialCaseNum, String descripeGeneralAnn,
	...
	public void createWarAttachWithOrderFirstTime(String serialOrderNum, String paperCount, String receiverCount,
	...
	public void createWarAttachWithOrderForSecondeTime(String serialOrderNum, String descripeGeneralAnn,
			String nationalId) throws InterruptedException {
		fluentWait(addBtn);
		clickBtn(addBtn);
		fluentWait(warAttachWithMajor);
