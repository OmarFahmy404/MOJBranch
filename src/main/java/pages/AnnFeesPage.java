...
public class AnnFeesPage extends PageBase {
	...
	@FindBy(xpath = "/html/body/ngb-modal-window/div/div/casetypelinkedwithorderwritpopup/div[2]/form/div/div[2]/div/ng-select/ng-dropdown-panel/div/div[2]/div[2]")
	...
	public void createAnnAttachWithCaseFirstTime(String serialCaseNum, String paperCount, String receiverCount,
		String nationalId, String descripeGeneralAnn) throws InterruptedException {
		fluentWait(addBtn);
		clickBtn(addBtn);
	...
	public void createAnnAttachWithCaseForSecondeTime(String serialCaseNum, String descripeGeneralAnn,
	...
	public void createAnnAttachWithOrderFirstTime(String serialOrderNum, String paperCount, String receiverCount,
			String nationalId, String descripeGeneralAnn) throws InterruptedException {
		fluentWait(addBtn);
		clickBtn(addBtn);
		fluentWait(annAttachWithMajor);
	...
	public void createAnnAttachWithOrderForSecondeTime(String serialOrderNum, String descripeGeneralAnn,
			String nationalId) throws InterruptedException {
		fluentWait(addBtn);
		clickBtn(addBtn);
		fluentWait(annAttachWithMajor);
