...
public class WarningsFrontPage extends PageBase
{

	public WarningsFrontPage(WebDriver driver) {
		super(driver);
	}
	...
	public void addDataInWarnings(String strangerNationalId)
	{
		fluentWait(creatWarBtn);
		clickBtn(creatWarBtn);
	
		fluentWait(addFromInsideTheCaseBtn);
		selectFromDropDownNGList(warTypeMajor, warTypeMinor);
