...
public class WarningsTest extends TestBase {
	...
	public void creatWarAttachWithCaseFirstTimeTest() throws InterruptedException {
		...
		Thread.sleep(1500);
		sAssert.assertTrue(warBack.statusTxt.getText().contains("تمت المراجعة"),
		...
		sAssert.assertTrue(warStatus.getAnnType().contains("عرض مبلغ مالي - متهرب من تحصيل الإيجار - إنذار عام"),
				"Annoucement types");
	...
	public void creatWarAttachWithOrderFirstTimeTest() throws InterruptedException {
		warFees = new WarningsFeesPage(driver);
		warFees.createWarAttachWithOrderFirstTime("8", "1", "1", "28711111111111", "صف الاعلان العام");
	...
	public void creatWarAttachWithOrderSecondeTimeTest() throws InterruptedException {
		warFees = new WarningsFeesPage(driver);
		warFees.createWarAttachWithOrderForSecondeTime("8", "اعلان عام", "28711111111111");
