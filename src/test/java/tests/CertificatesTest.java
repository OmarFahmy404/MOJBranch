...
public class CertificatesTest extends TestBase {
	...
	public void completeSessionCasesCertProcess() throws InterruptedException {
		...
		sAssert.assertTrue(CertificatesPage.displayTheCertificateBtn.isEnabled(),
				"The Certification Button is Displayed");
		sAssert.assertAll();
		Thread.sleep(2000);
	}
	...
	public void terroristGroupsCase() throws InterruptedException {
		...
		SoftAssert sAssert = new SoftAssert();
		sAssert.assertTrue(CertificatesPage.tGdisplayTheCertificateBtn.isEnabled(),
				"The Certification Button is Displayed");
		sAssert.assertAll();
	...
	public void caseNoExist() throws InterruptedException {
		...
		SoftAssert sAssert = new SoftAssert();
		sAssert.assertTrue(CertificatesPage.dDisplayTheCertificateBtn.isEnabled(),
				"The Certification Button is Displayed");
		sAssert.assertAll();
	}
